...
# setwd("/Users/etc")
# download the csv from the repo and update ^ to wherever you have it saved
...
htmlwidgets::saveWidget(imbd_finished, "/your path/imbd_finished.html", selfcontained=TRUE)
